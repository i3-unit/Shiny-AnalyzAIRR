...
```{r show other data title, results='asis', echo=FALSE}
if(!(is.null(input$otherDataList))){cat("**Other data**")}
```
...
```{r rep count, echo=FALSE, warning=FALSE, message=FALSE, error=TRUE}
if(!is.null(input$filterCountLevel) && !is.null(input$filterCountN) && !is.null(input$filterCountGroup) && input$doFilterCount == 1){
...
```{r productive, echo=FALSE, warning=FALSE, message=FALSE, error=TRUE}
...
```{r drop sample, echo=FALSE, warning=FALSE, message=FALSE, error=TRUE}
...
```{r public, echo=FALSE, warning=FALSE, message=FALSE, error=TRUE}
...
```{r private, echo=FALSE, warning=FALSE, message=FALSE, error=TRUE}
...
```{r topseq, echo=FALSE, warning=FALSE, message=FALSE, error=TRUE}
...
```{r down-sampling, echo=FALSE, warning=FALSE, message=FALSE, error=TRUE}
if(!is.null(input$downSampleSize) && !is.null(input$downseed) && !is.null(input$downReplace) && input$doDown == TRUE){
...
```{r shannon, echo=FALSE, echo=FALSE, warning=FALSE, message=FALSE, error=TRUE}
