...
if(params$renyiLevel != "" && params$renyicolor != ""){cat("### Generalized diversity")}
```
...
if(params$renyiLevel != "" && params$renyicolor != ""){
   plotGenDiversity(x=params$dataFiltered, level = params$renyiLevel,
                  colorBy = params$renyicolor, facetBy=params$renyifacet, 
                  Hill=params$multidoHill,
...
if(params$countIntLevel != "" && params$countIntGroupMeth != ""){
    plotIntervals(x=params$dataFiltered, level = params$countIntLevel, calculation_type = params$countIntCalType,
    grouped = FALSE, colorBy=NULL, facetBy= params$countIntfacet,  interval_scale=params$countIntGroupMeth, label_colors = NULL)
}
...
if(!is.null(params$multrenLevel) && !is.null(params$multrenGroup)){cat("### Generalized diversity")}
```
...
if(!is.null(params$multrenLevel) && !is.null(params$multrenGroup)){
    ...
    plotGenDiversity(x = params$dataFiltered, level = params$multrenLevel, 
                    colorBy = params$multrenGroup,  grouped = TRUE,  alpha = 
                      Hill=params$multidoHill,
...
if(!is.null(params$countIntervalsLevel) && !is.null(params$countIntervalsGroup) && !is.null(params$countIntervalsscale)){
    plotIntervals(x = params$dataFiltered, level = params$countIntervalsLevel, 
                   calculation_type = params$countIntCalType,
                  colorBy = params$countIntervalsGroup, interval_scale=params$countIntervalsscale, 
...
if(!is.null(params$dissimilarityLevel) && !is.null(params$dissimilarityLevel) && !is.null(params$dissimilarityIndex) && !is.null(params$dissimilarityClustering) && !is.null(params$multdissGroup) && params$doHm1 == 1){
    hm <- plotDissHeatmap(x = params$dataFiltered, level = params$dissimilarityLevel, method = params$dissimilarityIndex, binary = FALSE, clustering = params$dissimilarityClustering, label_colors = NULL, annotation_groups=params$multdissGroup, plot="Heatmap")
...
if(!is.null(params$MDSLevel) && !is.null(params$MDSMethod) && !is.null(params$multMDSGroup)){
    plotDissMDS(x = params$dataFiltered, level = params$MDSLevel, method = params$MDSMethod, label_colors = NULL, colorBy=params$multMDSGroup , shapeBy=params$multMDSShape, plot = "MDS")
}
