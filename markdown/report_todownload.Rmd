...
if(!is.null(params$MDSLevel) && !is.null(params$MDSMethod) && !is.null(params$multMDSGroup)){
    plotDissMDS(x = params$dataFiltered, level = params$MDSLevel, method = params$MDSMethod, label_colors = NULL, colorBy=params$multMDSGroup , shapeBy=params$multMDSShape)
}
