...
if((params$plotStats != ""  &&  !is.null(params$plotcolorgroup)) ||
   ...
   (params$renyiLevel != "" && !is.null(params$renyicolor) && !is.null(params$renyishape) &&
...
if(params$renyiLevel != "" && params$renyicolor != ""){
   plotRenyiIndex(x=params$dataFiltered, level = params$renyiLevel,
                  ...
                  shapeBy=params$renyishape, grouped = FALSE, label_colors = NULL)
}
...
if(!is.null(params$multrenLevel) && !is.null(params$multrenGroup)){
    if(is.null(params$multrenshape)){
      shape <- NULL
    } else {
      shape <- params$multrenshape
    }
    plotRenyiIndex(x = params$dataFiltered, level = params$multrenLevel, 
                    colorBy = params$multrenGroup, shapeBy=shape, grouped = TRUE, 
