...
if(!is.null(params$singleSample) && params$VJLevel != "" && !is.null(params$singleScale) && !is.null(params$VJProp)){
      if(params$VJViz == "Heatmap"){
        plotVJusage(x = dataFilt(), sampleName = params$singleSample, scale = params$singleScale, level = params$VJLevel, prop = params$VJProp, plot = "Heatmap")
    } else {
        plotVJusage(x = dataFilt(), sampleName = params$singleSample, scale = params$singleScale, level = params$VJLevel, prop = params$VJProp, plot = "Circos")    
    }
}
