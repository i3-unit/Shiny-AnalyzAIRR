...
if(!(is.null(params$otherDataList))){cat("**Other data**")}
```
...
if(!is.null(params$DownLevel) && params$doDown == TRUE){
   cts1 <- RepSeq::assay(params$repseqdt)
...
if(!is.null(params$countIntervalsLevel) && !is.null(params$countIntervalsGroup)){cat("### Count intervals")}
```
