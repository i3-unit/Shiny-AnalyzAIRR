...
assaydata <- AnalyzAIRR::assay(params$dataFiltered)
...
metadata <- AnalyzAIRR::mData(params$dataFiltered)
...
if(!(is.null(params$otherDataList))){
       otherdata <-  AnalyzAIRR::oData(params$dataFiltered)[[params$otherDataList]]
